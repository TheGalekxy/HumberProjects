...
namespace HTTP5101_Assignment5_n01454046.Controllers
{
    public class TeacherDataController : ApiController
    {
        ...
        public void UpdateTeacher(int id, [FromBody]Teacher TeacherInfo)
        {
            ...
            cmd.CommandText = "update teachers set teacherfname=@TeacherFname, teacherlname=@TeacherLname, employeenumber=@TeacherEmployeeNumber where teacherid=@TeacherId";
